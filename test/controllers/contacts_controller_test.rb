...
class ContactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact" do
    assert_difference("Contact.count") do
      post contacts_url, params: { contact: { address: @contact.address, city: @contact.city, company: @contact.company, country: @contact.country, email: @contact.email, first_name: @contact.first_name, job_title: @contact.job_title, last_name: @contact.last_name, notes: @contact.notes, phone: @contact.phone, postal_code: @contact.postal_code, state: @contact.state } }
    end
